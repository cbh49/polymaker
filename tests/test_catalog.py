...
def test_moneyline_slug_pattern():
    ...
    assert is_moneyline_slug("nfl-dal-nyg-2026-09-14")
    ...
    assert not is_moneyline_slug("nfl-dal-nyg-2026-09-14-player-props")
    ...
    assert is_spread_slug("nfl-dal-nyg-2026-09-14-spread-away-2pt5")
    ...
    assert is_total_slug("nfl-dal-nyg-2026-09-14-total-47pt5")
